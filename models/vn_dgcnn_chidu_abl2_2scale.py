"""
Ablation 2: backbone 只保留 2 层 VNLinearWithScale_PerPoint（conv1, conv2），
然后直接聚合多尺度特征送入后续 head，探究深度的影响。
"""
import torch
...
class get_model(nn.Module):
    def __init__(self, args, normal_channel=False):
        ...
        # 2 层 scale_conv 后直接聚合：16 + 32 = 48
        self.conv_agg = VNLinearLeakyReLU(16 + 32, 1024 // 3, dim=4, share_nonlinearity=True)
